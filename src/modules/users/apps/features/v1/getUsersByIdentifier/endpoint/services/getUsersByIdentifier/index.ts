...
export interface IGetUserByIdentifierService extends IServiceHandlerAsync<IGetUserByIdentifierServiceParameters,IUsers>{}
...
export class GetUserByIdentifierService implements IGetUserByIdentifierService{
  ...
  public async handleAsync(params: IGetUserByIdentifierServiceParameters): Promise<Result<IUsers, ResultError>> {
    try
    {
      // @Guard
      if(!params)
