...
export interface IGetUsersByIdentifierResponseMapperService
	extends IServiceHandlerAsync<IUsers, GetUserByIdentifierResponseDto> {}

@sealed
@Service()
export class GetUsersByIdentifierResponseMapperService
	implements IGetUsersByIdentifierResponseMapperService
{
