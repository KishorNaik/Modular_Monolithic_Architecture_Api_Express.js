...
export interface IGetUserByIdentifierMapEntityService extends IServiceHandlerAsync<IGetUserByIdentifierMapEntityServiceParameter,UserEntity>{
...
export class GetUserByIdentifierMapEntityService implements IGetUserByIdentifierMapEntityService {
  public async handleAsync(params: IGetUserByIdentifierMapEntityServiceParameter): Promise<Result<UserEntity, ResultError>> {
   try
   {
      // @Guard
      if(!params)
