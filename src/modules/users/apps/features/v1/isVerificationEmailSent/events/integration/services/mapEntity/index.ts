...
export interface IIsVerificationEmailSendIntegrationEventMapEntityService extends IServiceHandlerAsync<IUsers,UserSettingsEntity>{}

@sealed
@Service()
export class IsVerificationEmailSendIntegrationEventMapEntityService implements IIsVerificationEmailSendIntegrationEventMapEntityService{
