...
import { IUserSignInGenerateJwtAndRefreshTokenServiceResult, UserSignInGenerateJwtAndRefreshTokenService } from '@/modules/users/shared/services/generateJwtAndRefresh';
import { RoleEnum } from '@/shared/models/enums/role.enum';
import { IMapRefreshTokenUserEntityServiceResults, MapRefreshTokenUserEntityService } from '@/modules/users/shared/services/mapRefrehToken';
...
export class UpdateRefreshTokenController {
  ...
  public async updateRefreshToken(@Body() request: AesRequestDto, @Req() req: Request, @Res() res: Response) {
...
class UpdateRefreshTokenCommandHandler implements RequestHandler<UpdateRefreshTokenCommand,ApiDataResponse<AesResponseDto>>{
  ...
  public constructor(){
    ...
    this._updateRefreshTokenRequestValidationService=Container.get(UpdateRefreshTokenRequestValidationService);
    this._isValidJwtAndRefreshTokenService=Container.get(IsValidJwtAndRefreshTokenService);
    this._userSignInGenerateJwtAndRefreshTokenService=Container.get(UserSignInGenerateJwtAndRefreshTokenService);
    ...
    this._mapUpdateRefreshTokenResponseService=Container.get(MapUpdateRefreshTokenResponseService);
    this._updateRefreshTokenEncryptResponseService=Container.get(UpdateRefreshTokenEncryptResponseService);
  }

  public async handle(value: UpdateRefreshTokenCommand): Promise<ApiDataResponse<AesResponseDto>> {
    ...
    try
    {
      ...
      // Get Users
      const getUsersByClientIdServiceResult = await this._getUsersByClientIdService.handleAsync({
        clientId: clientId,
      });
      if(getUsersByClientIdServiceResult.isErr()){
        logger.error(
          ...
          return DataResponseFactory.error(getUsersByClientIdServiceResult.error.status,getUsersByClientIdServiceResult.error.message);
      }
      ...
      // Decrypt Service
      const refreshTokenDecryptRequestServiceResult = await this._refreshTokenDecryptRequestService.handleAsync({
      ...
      if(refreshTokenDecryptRequestServiceResult.isErr())
      {
        ...
        return DataResponseFactory.error(refreshTokenDecryptRequestServiceResult.error.status,refreshTokenDecryptRequestServiceResult.error.message);
      }
      ...
      // Validation Service
      const updateRefreshTokenRequestValidationServiceResult = await this._updateRefreshTokenRequestValidationService.handleAsync({
        dto:request,
      ...
      if(updateRefreshTokenRequestValidationServiceResult.isErr()){
        ...
        return DataResponseFactory.error(updateRefreshTokenRequestValidationServiceResult.error.status,updateRefreshTokenRequestValidationServiceResult.error.message);
      }
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
      ...
      // Is Valid Token
      const isValidJwtAndRefreshTokenServiceResult = await this._isValidJwtAndRefreshTokenService.handleAsync({
        token:request,
        users:users,
      });
      if(isValidJwtAndRefreshTokenServiceResult.isErr()){
        ...
        return DataResponseFactory.error(isValidJwtAndRefreshTokenServiceResult.error.status,isValidJwtAndRefreshTokenServiceResult.error.message);
      }
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
      ...
      const userSignInGenerateJwtAndRefreshTokenServiceResult=await this._userSignInGenerateJwtAndRefreshTokenService.handleAsync({
      ...
      if(userSignInGenerateJwtAndRefreshTokenServiceResult.isErr())
      {
        ...
        return DataResponseFactory.error(userSignInGenerateJwtAndRefreshTokenServiceResult.error.status,userSignInGenerateJwtAndRefreshTokenServiceResult.error.message);
      }
      const userSignInGenerateJwtAndRefreshTokenResult:IUserSignInGenerateJwtAndRefreshTokenServiceResult=userSignInGenerateJwtAndRefreshTokenServiceResult.value;
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
          `UserSignInGenerateJwtAndRefreshTokenService`,
      ...
      if(mapRefreshTokenUserEntityServiceResult.isErr()){
        ...
        return DataResponseFactory.error(mapRefreshTokenUserEntityServiceResult.error.status,mapRefreshTokenUserEntityServiceResult.error.message);
      }

      const mapRefreshTokenUserEntityResult:IMapRefreshTokenUserEntityServiceResults=mapRefreshTokenUserEntityServiceResult.value;
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
          `MapRefreshTokenUserEntityService`,
      ...
      const updateRefreshTokenDbServiceResult=await this._updateRefreshTokenDbService.handleAsync({
        entity:{
      ...
      if(updateRefreshTokenDbServiceResult.isErr()){
        logger.error(
          ...
          logger.warn(
            logConstruct(`UpdateRefreshTokenCommandHandler`, `UpdateRefreshTokenDbService`, `Rollback Transaction`)
          );

          return DataResponseFactory.error(updateRefreshTokenDbServiceResult.error.status,updateRefreshTokenDbServiceResult.error.message);
      }
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
      ...
      if(userSharedCacheServiceResult.isErr()){
        ...
        await queryRunner.rollbackTransaction();
        logger.warn(
          logConstruct(`UpdateRefreshTokenCommandHandler`, `UserSharedCacheService`, `Rollback Transaction`)
        );
      ...
      // Map Response
      const mapUpdateRefreshTokenResponseServiceResult=await this._mapUpdateRefreshTokenResponseService.handleAsync(userSignInGenerateJwtAndRefreshTokenResult);
      if(mapUpdateRefreshTokenResponseServiceResult.isErr()){
        ...
        logger.warn(
          logConstruct(`UpdateRefreshTokenCommandHandler`, `MapUpdateRefreshTokenResponseService`, `Rollback Transaction`)
        );

        return DataResponseFactory.error(mapUpdateRefreshTokenResponseServiceResult.error.status,mapUpdateRefreshTokenResponseServiceResult.error.message);
      }

     const refreshTokenResponseDto:RefreshTokenResponseDto=mapUpdateRefreshTokenResponseServiceResult.value;
      logger.info(
        logConstruct(
          `UpdateRefreshTokenCommandHandler`,
          `MapUpdateRefreshTokenResponseService`,
      ...
      // Encrypt Response
      const updateRefreshTokenEncryptResponseServiceResult=await this._updateRefreshTokenEncryptResponseService.handleAsync({
      ...
      if(updateRefreshTokenEncryptResponseServiceResult.isErr()){
        ...
        logger.warn(
          logConstruct(`UpdateRefreshTokenCommandHandler`, `UpdateRefreshTokenEncryptResponseService`, `Rollback Transaction`)
        );

        return DataResponseFactory.error(updateRefreshTokenEncryptResponseServiceResult.error.status,updateRefreshTokenEncryptResponseServiceResult.error.message);
      }

      const aesResponseDto:AesResponseDto=updateRefreshTokenEncryptResponseServiceResult.value.aesResponseDto;
      ...
      const error = ex as Error;
        logger.error(logConstruct(`UpdateRefreshTokenCommandHandler`, `handle`, error.message, ex));
        if (queryRunner.isTransactionActive) {
          await queryRunner.rollbackTransaction();
          logger.warn(
            logConstruct(`UpdateRefreshTokenCommandHandler`, `handle`, `Rollback Transaction`)
          );
        }
      ...
      await queryRunner.release();
			logger.info(logConstruct(`UpdateRefreshTokenCommandHandler`, `handle`, `Release Transaction`));
    }
  }
