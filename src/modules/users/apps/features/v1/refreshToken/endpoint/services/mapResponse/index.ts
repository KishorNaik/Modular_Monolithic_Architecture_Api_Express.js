...
export interface IMapUpdateRefreshTokenService
...
export class MapUpdateRefreshTokenResponseService implements IMapUpdateRefreshTokenService {
	public async handleAsync(
		params: IUserSignInGenerateJwtAndRefreshTokenServiceResult
	): Promise<Result<RefreshTokenResponseDto, ResultError>> {
		try {
			if (!params)
