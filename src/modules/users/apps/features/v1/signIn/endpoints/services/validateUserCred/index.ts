...
export interface IUserSignInValidateCredentialsService
	extends IServiceHandlerVoidAsync<IUserSignInValidateCredentialsServiceParameters> {}
...
export class UserSignInValidateCredentialsService implements IUserSignInValidateCredentialsService {
	...
	public async handleAsync(
		params: IUserSignInValidateCredentialsServiceParameters
		...
		try {
			...
			const comparePasswordResult = await this._hashPasswordService.comparePasswordAsync(
				rawPassword,
				hash
			);
