...
export interface IMapUpdateUserRequestToEntityService
	extends IServiceHandlerAsync<
		IMapUpdateUserRequestToEntityParameters,
...
export class MapUpdateUserRequestToEntityService implements IMapUpdateUserRequestToEntityService {
	public async handleAsync(
		params: IMapUpdateUserRequestToEntityParameters
	): Promise<Result<IMapUpdateUserRequestToEntityResults, ResultError>> {
		try {
			//@guard
			if (!params)
