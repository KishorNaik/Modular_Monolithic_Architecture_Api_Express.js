...
export interface IMapVerifyUserRequestDtoToEntityService
	extends IServiceHandlerAsync<VerifyUserRequestDto, UserSettingsEntity> {}

@sealed
@Service()
export class MapVerifyUserRequestDtoToEntityService
	implements IMapVerifyUserRequestDtoToEntityService
{
	public async handleAsync(
		params: VerifyUserRequestDto
