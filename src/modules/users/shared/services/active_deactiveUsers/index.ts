...
export interface IActiveDeactivateUsersDbService
	extends IServiceHandlerVoidAsync<IActiveDeactivateUsersDbServiceParameters> {}
...
export class ActiveDeactivateUsersDbService implements IActiveDeactivateUsersDbService {
	...
	public async handleAsync(
		params: IActiveDeactivateUsersDbServiceParameters
