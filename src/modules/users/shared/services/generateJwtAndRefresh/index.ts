...
export interface IUserSignInGenerateJwtAndRefreshTokenService
	extends IServiceHandlerAsync<
		IUseSignInGenerateJwtAndRefreshTokenServiceParameters,
		IUserSignInGenerateJwtAndRefreshTokenServiceResult
	> {}

@sealed
@Service()
export class UserSignInGenerateJwtAndRefreshTokenService
	implements IUserSignInGenerateJwtAndRefreshTokenService
{
	...
	public async handleAsync(
		params: IUseSignInGenerateJwtAndRefreshTokenServiceParameters
	): Promise<Result<IUserSignInGenerateJwtAndRefreshTokenServiceResult, ResultError>> {
		try {
			//@Guard
			if (!params)
