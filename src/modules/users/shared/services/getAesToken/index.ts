...
export interface IGetAesTokenService
	extends IServiceHandlerAsync<IGetAesTokenServiceParameters, IGetAesTokenServiceResult> {}
...
export class GetAesTokenService implements IGetAesTokenService {
	...
	public async handleAsync(
		params: IGetAesTokenServiceParameters
	): Promise<Result<IGetAesTokenServiceResult, ResultError>> {
		try {
			// @Guard
			if (!params)
