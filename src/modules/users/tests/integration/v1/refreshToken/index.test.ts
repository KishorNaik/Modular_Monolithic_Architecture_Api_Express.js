...
describe(`Refresh Token Integration Test`, () => {
	...
	it(`should_return_false_when_refresh_token_is_provided_wrong`, async () => {
		...
		const refreshToken: string =
			'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImUzMGZmNjNlLWNhYTEtNWRjMC05OWE1LTUwNGYxNGU1NTMxNyIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzQ1MDgwNzYyLCJleHAiOjE3NDU2ODU1NjJ9.eVraEHXbhz-Lwm73L4Y8iV1b0YvpqzCtvFihI2L_Q7s';
